...
enum ConnectGazeboToRosTopic_MsgType {
  ...
  ConnectGazeboToRosTopic_MsgType_IMU = 2,
  ConnectGazeboToRosTopic_MsgType_JOINT_STATE = 3,
  ConnectGazeboToRosTopic_MsgType_MAGNETIC_FIELD = 4,
  ConnectGazeboToRosTopic_MsgType_NAV_SAT_FIX = 5,
  ConnectGazeboToRosTopic_MsgType_ODOMETRY = 6,
  ConnectGazeboToRosTopic_MsgType_POSE = 7,
  ConnectGazeboToRosTopic_MsgType_POSE_WITH_COVARIANCE_STAMPED = 8,
  ConnectGazeboToRosTopic_MsgType_TRANSFORM_STAMPED = 9,
  ConnectGazeboToRosTopic_MsgType_TWIST_STAMPED = 10,
  ConnectGazeboToRosTopic_MsgType_VECTOR_3D_STAMPED = 11,
  ConnectGazeboToRosTopic_MsgType_WIND_SPEED = 12,
  ConnectGazeboToRosTopic_MsgType_WRENCH_STAMPED = 13
};
