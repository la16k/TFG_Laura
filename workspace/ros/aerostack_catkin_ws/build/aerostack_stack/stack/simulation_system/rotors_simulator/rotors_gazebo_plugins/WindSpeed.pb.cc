...
void protobuf_AddDesc_WindSpeed_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\017WindSpeed.proto\022\022gz_mav_msgs_rotors\032\014H"
    "eader.proto\032\016vector3d.proto\"Y\n\tWindSpeed"
    "\022#\n\006header\030\001 \002(\0132\023.gz_std_msgs.Header\022\'\n"
    "\010velocity\030\002 \002(\0132\025.gazebo.msgs.Vector3d", 158);
...
WindSpeed::WindSpeed()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:gz_mav_msgs_rotors.WindSpeed)
}
...
WindSpeed::WindSpeed(const WindSpeed& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:gz_mav_msgs_rotors.WindSpeed)
}
...
WindSpeed::~WindSpeed() {
  // @@protoc_insertion_point(destructor:gz_mav_msgs_rotors.WindSpeed)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:gz_mav_msgs_rotors.WindSpeed)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:gz_mav_msgs_rotors.WindSpeed)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:gz_mav_msgs_rotors.WindSpeed)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:gz_mav_msgs_rotors.WindSpeed)
  return false;
#undef DO_
}
...
void WindSpeed::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:gz_mav_msgs_rotors.WindSpeed)
  // required .gz_std_msgs.Header header = 1;
  if (has_header()) {
  ...
  // @@protoc_insertion_point(serialize_end:gz_mav_msgs_rotors.WindSpeed)
}

::google::protobuf::uint8* WindSpeed::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:gz_mav_msgs_rotors.WindSpeed)
  // required .gz_std_msgs.Header header = 1;
  if (has_header()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:gz_mav_msgs_rotors.WindSpeed)
  return target;
}

int WindSpeed::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:gz_mav_msgs_rotors.WindSpeed)
  int total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:gz_mav_msgs_rotors.WindSpeed)
  int total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:gz_mav_msgs_rotors.WindSpeed)
  ...
  const WindSpeed* source = 
      ::google::protobuf::internal::DynamicCastToGenerated<const WindSpeed>(
          &from);
  if (source == NULL) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:gz_mav_msgs_rotors.WindSpeed)
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:gz_mav_msgs_rotors.WindSpeed)
    MergeFrom(*source);
  }
}

void WindSpeed::MergeFrom(const WindSpeed& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:gz_mav_msgs_rotors.WindSpeed)
  if (GOOGLE_PREDICT_FALSE(&from == this)) {
    ::google::protobuf::internal::MergeFromFail(__FILE__, __LINE__);
  }
...
// @@protoc_insertion_point(generalized_copy_from_start:gz_mav_msgs_rotors.WindSpeed)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:gz_mav_msgs_rotors.WindSpeed)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::gz_std_msgs::Header& WindSpeed::header() const {
  // @@protoc_insertion_point(field_get:gz_mav_msgs_rotors.WindSpeed.header)
...
::gz_std_msgs::Header* WindSpeed::mutable_header() {
  ...
  // @@protoc_insertion_point(field_mutable:gz_mav_msgs_rotors.WindSpeed.header)
  return header_;
}
::gz_std_msgs::Header* WindSpeed::release_header() {
  // @@protoc_insertion_point(field_release:gz_mav_msgs_rotors.WindSpeed.header)
  clear_has_header();
...
void WindSpeed::set_allocated_header(::gz_std_msgs::Header* header) {
  ...
  // @@protoc_insertion_point(field_set_allocated:gz_mav_msgs_rotors.WindSpeed.header)
}
...
const ::gazebo::msgs::Vector3d& WindSpeed::velocity() const {
  // @@protoc_insertion_point(field_get:gz_mav_msgs_rotors.WindSpeed.velocity)
...
::gazebo::msgs::Vector3d* WindSpeed::mutable_velocity() {
  ...
  // @@protoc_insertion_point(field_mutable:gz_mav_msgs_rotors.WindSpeed.velocity)
  return velocity_;
}
::gazebo::msgs::Vector3d* WindSpeed::release_velocity() {
  // @@protoc_insertion_point(field_release:gz_mav_msgs_rotors.WindSpeed.velocity)
  clear_has_velocity();
...
void WindSpeed::set_allocated_velocity(::gazebo::msgs::Vector3d* velocity) {
  ...
  // @@protoc_insertion_point(field_set_allocated:gz_mav_msgs_rotors.WindSpeed.velocity)
}
