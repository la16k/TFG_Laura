...
void protobuf_AssignDesc_Actuators_2eproto() {
  ...
  static const int Actuators_offsets_[2] = {
...
void protobuf_AddDesc_Actuators_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "z_std_msgs.Header\022\036\n\022angular_velocities\030"
    "\002 \003(\001B\002\020\001", 129);
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(18)) goto parse_angular_velocities;
        break;
      }
        ...
        if (tag == 18) {
         parse_angular_velocities:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadRepeatedPrimitiveNoInline<
                   double, ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE>(
                 1, 18, input, this->mutable_angular_velocities())));
        } else {
          goto handle_unusual;
        }
