...
public:
    ...
    {
        MissionSpecificationDialog->setWindowTitle(QApplication::translate("MissionSpecificationDialog", "Create a new behavior tree", Q_NULLPTR));
        label->setText(QApplication::translate("MissionSpecificationDialog", "Insert the name of the behavior tree", Q_NULLPTR));
