...
(cl:defmethod cl:initialize-instance :after ((m <PointInImage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointInImage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aruco_eye_msgs-msg:<PointInImage> is deprecated: use aruco_eye_msgs-msg:PointInImage instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <PointInImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco_eye_msgs-msg:x-val is deprecated.  Use aruco_eye_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <PointInImage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco_eye_msgs-msg:y-val is deprecated.  Use aruco_eye_msgs-msg:y instead.")
  (y m))
