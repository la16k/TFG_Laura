...
(cl:defclass <MarkerList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector aruco_eye_msgs-msg:Marker)
   :initform (cl:make-array 0 :element-type 'aruco_eye_msgs-msg:Marker :initial-element (cl:make-instance 'aruco_eye_msgs-msg:Marker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <MarkerList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MarkerList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aruco_eye_msgs-msg:<MarkerList> is deprecated: use aruco_eye_msgs-msg:MarkerList instead.")))
...
(cl:defmethod imageTopicName-val ((m <MarkerList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco_eye_msgs-msg:imageTopicName-val is deprecated.  Use aruco_eye_msgs-msg:imageTopicName instead.")
  (imageTopicName m))

(cl:ensure-generic-function 'markers-val :lambda-list '(m))
(cl:defmethod markers-val ((m <MarkerList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aruco_eye_msgs-msg:markers-val is deprecated.  Use aruco_eye_msgs-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <MarkerList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'aruco_eye_msgs-msg:Marker))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MarkerList>)))
  ...
  (cl:format cl:nil "# Header~%Header header~%~%# Image info~%string imageTopicName~%~%# List of visual markers~%aruco_eye_msgs/Marker[] markers~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: aruco_eye_msgs/Marker~%# Header. Needed for the frame_id~%Header header~%~%# Id of the visual marker~%uint32 id~%~%# Size of the visual marker if available~%float32 size~%~%# Points of the visual marker in the Image~%aruco_eye_msgs/PointInImage[] pointsInImage~%~%# Flag for the 3D reconstruction~%bool is3dReconstructed~%~%# Pose of the Visual Marker wrt Camera if calibration file is available~%geometry_msgs/PoseWithCovariance pose~%~%# Confidence in the detection. TODO~%float64 confidence~%~%================================================================================~%MSG: aruco_eye_msgs/PointInImage~%# x coordinate of the point in the image~%float32 x~%# y coordinate of the poitn in the image~%float32 y~%~%================================================================================~%MSG: geometry_msgs/PoseWithCovariance~%# This represents a pose in free space with uncertainty.~%~%Pose pose~%~%# Row-major representation of the 6x6 covariance matrix~%# The orientation parameters use a fixed-axis representation.~%# In order, the parameters are:~%# (x, y, z, rotation about X axis, rotation about Y axis, rotation about Z axis)~%float64[36] covariance~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MarkerList)))
  "Returns full string definition for message of type 'MarkerList"
  (cl:format cl:nil "# Header~%Header header~%~%# Image info~%string imageTopicName~%~%# List of visual markers~%aruco_eye_msgs/Marker[] markers~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: aruco_eye_msgs/Marker~%# Header. Needed for the frame_id~%Header header~%~%# Id of the visual marker~%uint32 id~%~%# Size of the visual marker if available~%float32 size~%~%# Points of the visual marker in the Image~%aruco_eye_msgs/PointInImage[] pointsInImage~%~%# Flag for the 3D reconstruction~%bool is3dReconstructed~%~%# Pose of the Visual Marker wrt Camera if calibration file is available~%geometry_msgs/PoseWithCovariance pose~%~%# Confidence in the detection. TODO~%float64 confidence~%~%================================================================================~%MSG: aruco_eye_msgs/PointInImage~%# x coordinate of the point in the image~%float32 x~%# y coordinate of the poitn in the image~%float32 y~%~%================================================================================~%MSG: geometry_msgs/PoseWithCovariance~%# This represents a pose in free space with uncertainty.~%~%Pose pose~%~%# Row-major representation of the 6x6 covariance matrix~%# The orientation parameters use a fixed-axis representation.~%# In order, the parameters are:~%# (x, y, z, rotation about X axis, rotation about Y axis, rotation about Z axis)~%float64[36] covariance~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
