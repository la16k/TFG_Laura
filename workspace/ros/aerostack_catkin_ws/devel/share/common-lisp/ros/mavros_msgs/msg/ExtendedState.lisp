...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ExtendedState>)))
  ...
  "c2e3721f1a54980a39715b775091885e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ExtendedState)))
  "Returns md5sum for a message object of type 'ExtendedState"
  "c2e3721f1a54980a39715b775091885e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ExtendedState>)))
  ...
  (cl:format cl:nil "# Extended autopilot state~%#~%# http://mavlink.org/messages/common#EXTENDED_SYS_STATE~%~%uint8 VTOL_STATE_UNDEFINED = 0~%uint8 VTOL_STATE_TRANSITION_TO_FW = 1~%uint8 VTOL_STATE_TRANSITION_TO_MC = 2~%uint8 VTOL_STATE_MC = 3~%uint8 VTOL_STATE_FW = 4~%~%uint8 LANDED_STATE_UNDEFINED = 0~%uint8 LANDED_STATE_ON_GROUND = 1~%uint8 LANDED_STATE_IN_AIR = 2~%~%std_msgs/Header header~%uint8 vtol_state~%uint8 landed_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ExtendedState)))
  "Returns full string definition for message of type 'ExtendedState"
  (cl:format cl:nil "# Extended autopilot state~%#~%# http://mavlink.org/messages/common#EXTENDED_SYS_STATE~%~%uint8 VTOL_STATE_UNDEFINED = 0~%uint8 VTOL_STATE_TRANSITION_TO_FW = 1~%uint8 VTOL_STATE_TRANSITION_TO_MC = 2~%uint8 VTOL_STATE_MC = 3~%uint8 VTOL_STATE_FW = 4~%~%uint8 LANDED_STATE_UNDEFINED = 0~%uint8 LANDED_STATE_ON_GROUND = 1~%uint8 LANDED_STATE_IN_AIR = 2~%~%std_msgs/Header header~%uint8 vtol_state~%uint8 landed_state~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
