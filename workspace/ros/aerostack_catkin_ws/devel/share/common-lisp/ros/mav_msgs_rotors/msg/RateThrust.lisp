...
(cl:defmethod cl:initialize-instance :after ((m <RateThrust>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RateThrust)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mav_msgs_rotors-msg:<RateThrust> is deprecated: use mav_msgs_rotors-msg:RateThrust instead.")))
...
(cl:defmethod angular_rates-val ((m <RateThrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_msgs_rotors-msg:angular_rates-val is deprecated.  Use mav_msgs_rotors-msg:angular_rates instead.")
  (angular_rates m))
