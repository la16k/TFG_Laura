...
(cl:defmethod cl:initialize-instance :after ((m <TorqueThrust>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TorqueThrust)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mav_msgs_rotors-msg:<TorqueThrust> is deprecated: use mav_msgs_rotors-msg:TorqueThrust instead.")))
...
(cl:defmethod torque-val ((m <TorqueThrust>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_msgs_rotors-msg:torque-val is deprecated.  Use mav_msgs_rotors-msg:torque instead.")
  (torque m))
