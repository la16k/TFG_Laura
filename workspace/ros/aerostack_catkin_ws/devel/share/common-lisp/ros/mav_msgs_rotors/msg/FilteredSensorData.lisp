...
(cl:defmethod cl:initialize-instance :after ((m <FilteredSensorData>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FilteredSensorData)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mav_msgs_rotors-msg:<FilteredSensorData> is deprecated: use mav_msgs_rotors-msg:FilteredSensorData instead.")))
...
(cl:defmethod accelerometer-val ((m <FilteredSensorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_msgs_rotors-msg:accelerometer-val is deprecated.  Use mav_msgs_rotors-msg:accelerometer instead.")
  (accelerometer m))

(cl:ensure-generic-function 'gyroscope-val :lambda-list '(m))
(cl:defmethod gyroscope-val ((m <FilteredSensorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_msgs_rotors-msg:gyroscope-val is deprecated.  Use mav_msgs_rotors-msg:gyroscope instead.")
  (gyroscope m))

(cl:ensure-generic-function 'magnetometer-val :lambda-list '(m))
(cl:defmethod magnetometer-val ((m <FilteredSensorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_msgs_rotors-msg:magnetometer-val is deprecated.  Use mav_msgs_rotors-msg:magnetometer instead.")
  (magnetometer m))

(cl:ensure-generic-function 'barometer-val :lambda-list '(m))
(cl:defmethod barometer-val ((m <FilteredSensorData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mav_msgs_rotors-msg:barometer-val is deprecated.  Use mav_msgs_rotors-msg:barometer instead.")
  (barometer m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FilteredSensorData>)))
  ...
  "mav_msgs_rotors/FilteredSensorData")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FilteredSensorData)))
  "Returns string type for a message object of type 'FilteredSensorData"
  "mav_msgs_rotors/FilteredSensorData")
