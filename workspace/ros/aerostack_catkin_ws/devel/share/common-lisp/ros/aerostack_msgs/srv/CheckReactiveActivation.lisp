...
(cl:defmethod cl:initialize-instance :after ((m <CheckReactiveActivation-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckReactiveActivation-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aerostack_msgs-srv:<CheckReactiveActivation-request> is deprecated: use aerostack_msgs-srv:CheckReactiveActivation-request instead.")))
...
(cl:defmethod reactive_behaviors-val ((m <CheckReactiveActivation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aerostack_msgs-srv:reactive_behaviors-val is deprecated.  Use aerostack_msgs-srv:reactive_behaviors instead.")
...
(cl:defmethod active_behaviors-val ((m <CheckReactiveActivation-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aerostack_msgs-srv:active_behaviors-val is deprecated.  Use aerostack_msgs-srv:active_behaviors instead.")
  (active_behaviors m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckReactiveActivation-request>)))
  ...
  "aerostack_msgs/CheckReactiveActivationRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckReactiveActivation-request)))
  "Returns string type for a service object of type 'CheckReactiveActivation-request"
  "aerostack_msgs/CheckReactiveActivationRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CheckReactiveActivation-request>)))
  ...
  (cl:format cl:nil "# This service returns the list of behaviors that can be activated in a reactive way~%~%BehaviorCommand[] reactive_behaviors          # Contains every reactive behavior available (with high ir low priority)~%BehaviorCommand[] active_behaviors            # Contains every deliberative behavior~%~%================================================================================~%MSG: aerostack_msgs/BehaviorCommand~%# Request to execute a behavior with a set of arguments~%~%string name       # Behavior name~%string arguments  # Arguments of the behavior~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CheckReactiveActivation-request)))
  "Returns full string definition for message of type 'CheckReactiveActivation-request"
  (cl:format cl:nil "# This service returns the list of behaviors that can be activated in a reactive way~%~%BehaviorCommand[] reactive_behaviors          # Contains every reactive behavior available (with high ir low priority)~%BehaviorCommand[] active_behaviors            # Contains every deliberative behavior~%~%================================================================================~%MSG: aerostack_msgs/BehaviorCommand~%# Request to execute a behavior with a set of arguments~%~%string name       # Behavior name~%string arguments  # Arguments of the behavior~%~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <CheckReactiveActivation-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckReactiveActivation-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aerostack_msgs-srv:<CheckReactiveActivation-response> is deprecated: use aerostack_msgs-srv:CheckReactiveActivation-response instead.")))
...
(cl:defmethod high_priority_behaviors-val ((m <CheckReactiveActivation-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aerostack_msgs-srv:high_priority_behaviors-val is deprecated.  Use aerostack_msgs-srv:high_priority_behaviors instead.")
...
(cl:defmethod low_priority_behaviors-val ((m <CheckReactiveActivation-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aerostack_msgs-srv:low_priority_behaviors-val is deprecated.  Use aerostack_msgs-srv:low_priority_behaviors instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckReactiveActivation-response>)))
  ...
  "aerostack_msgs/CheckReactiveActivationResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckReactiveActivation-response)))
  "Returns string type for a service object of type 'CheckReactiveActivation-response"
  "aerostack_msgs/CheckReactiveActivationResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckReactiveActivation)))
  ...
  "aerostack_msgs/CheckReactiveActivation")