...
(cl:defmethod cl:initialize-instance :after ((m <BehaviorSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BehaviorSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aerostack_msgs-srv:<BehaviorSrv-request> is deprecated: use aerostack_msgs-srv:BehaviorSrv-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BehaviorSrv-request>)))
  ...
  "aerostack_msgs/BehaviorSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BehaviorSrv-request)))
  "Returns string type for a service object of type 'BehaviorSrv-request"
  "aerostack_msgs/BehaviorSrvRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BehaviorSrv-request>)))
  ...
  (cl:format cl:nil "# This service starts or activates or inhibits a behavior~%~%BehaviorCommand behavior            # The name of the behavior to activate and its argument~%~%================================================================================~%MSG: aerostack_msgs/BehaviorCommand~%# Request to execute a behavior with a set of arguments~%~%string name       # Behavior name~%string arguments  # Arguments of the behavior~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BehaviorSrv-request)))
  "Returns full string definition for message of type 'BehaviorSrv-request"
  (cl:format cl:nil "# This service starts or activates or inhibits a behavior~%~%BehaviorCommand behavior            # The name of the behavior to activate and its argument~%~%================================================================================~%MSG: aerostack_msgs/BehaviorCommand~%# Request to execute a behavior with a set of arguments~%~%string name       # Behavior name~%string arguments  # Arguments of the behavior~%~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <BehaviorSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BehaviorSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aerostack_msgs-srv:<BehaviorSrv-response> is deprecated: use aerostack_msgs-srv:BehaviorSrv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BehaviorSrv-response>)))
  ...
  "aerostack_msgs/BehaviorSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BehaviorSrv-response)))
  "Returns string type for a service object of type 'BehaviorSrv-response"
  "aerostack_msgs/BehaviorSrvResponse")
