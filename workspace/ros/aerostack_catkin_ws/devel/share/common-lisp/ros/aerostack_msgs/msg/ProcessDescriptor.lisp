...
(cl:defmethod cl:initialize-instance :after ((m <ProcessDescriptor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ProcessDescriptor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aerostack_msgs-msg:<ProcessDescriptor> is deprecated: use aerostack_msgs-msg:ProcessDescriptor instead.")))
...
(cl:defmethod last_signal-val ((m <ProcessDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aerostack_msgs-msg:last_signal-val is deprecated.  Use aerostack_msgs-msg:last_signal instead.")
  (last_signal m))

(cl:ensure-generic-function 'is_alive-val :lambda-list '(m))
(cl:defmethod is_alive-val ((m <ProcessDescriptor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aerostack_msgs-msg:is_alive-val is deprecated.  Use aerostack_msgs-msg:is_alive instead.")
  (is_alive m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ProcessDescriptor>)))
  ...
  "aerostack_msgs/ProcessDescriptor")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ProcessDescriptor)))
  "Returns string type for a message object of type 'ProcessDescriptor"
  "aerostack_msgs/ProcessDescriptor")
