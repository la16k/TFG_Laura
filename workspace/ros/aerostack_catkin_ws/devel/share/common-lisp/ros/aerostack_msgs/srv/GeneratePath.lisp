...
(cl:defmethod cl:initialize-instance :after ((m <GeneratePath-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GeneratePath-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aerostack_msgs-srv:<GeneratePath-request> is deprecated: use aerostack_msgs-srv:GeneratePath-request instead.")))

(cl:ensure-generic-function 'goal-val :lambda-list '(m))
(cl:defmethod goal-val ((m <GeneratePath-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader aerostack_msgs-srv:goal-val is deprecated.  Use aerostack_msgs-srv:goal instead.")
  (goal m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GeneratePath-request>)))
  ...
  "aerostack_msgs/GeneratePathRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GeneratePath-request)))
  "Returns string type for a service object of type 'GeneratePath-request"
  "aerostack_msgs/GeneratePathRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GeneratePath-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GeneratePath-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name aerostack_msgs-srv:<GeneratePath-response> is deprecated: use aerostack_msgs-srv:GeneratePath-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GeneratePath-response>)))
  ...
  "aerostack_msgs/GeneratePathResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GeneratePath-response)))
  "Returns string type for a service object of type 'GeneratePath-response"
  "aerostack_msgs/GeneratePathResponse")
