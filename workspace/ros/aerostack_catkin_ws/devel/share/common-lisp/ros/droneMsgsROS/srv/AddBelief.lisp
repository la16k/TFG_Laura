...
(cl:defmethod cl:initialize-instance :after ((m <AddBelief-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddBelief-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-srv:<AddBelief-request> is deprecated: use droneMsgsROS-srv:AddBelief-request instead.")))

(cl:ensure-generic-function 'multivalued-val :lambda-list '(m))
(cl:defmethod multivalued-val ((m <AddBelief-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader droneMsgsROS-srv:multivalued-val is deprecated.  Use droneMsgsROS-srv:multivalued instead.")
  (multivalued m))
...
(cl:defmethod cl:initialize-instance :after ((m <AddBelief-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AddBelief-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-srv:<AddBelief-response> is deprecated: use droneMsgsROS-srv:AddBelief-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<AddBelief-response>)))
  ...
  "droneMsgsROS/AddBeliefResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'AddBelief-response)))
  "Returns string type for a service object of type 'AddBelief-response"
  "droneMsgsROS/AddBeliefResponse")
