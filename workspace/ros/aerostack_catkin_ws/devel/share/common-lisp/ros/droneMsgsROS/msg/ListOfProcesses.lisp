...
(cl:defmethod cl:initialize-instance :after ((m <ListOfProcesses>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ListOfProcesses)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-msg:<ListOfProcesses> is deprecated: use droneMsgsROS-msg:ListOfProcesses instead.")))
