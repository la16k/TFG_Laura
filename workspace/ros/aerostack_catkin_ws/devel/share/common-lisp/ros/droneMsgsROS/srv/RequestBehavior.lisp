...
(cl:defmethod cl:initialize-instance :after ((m <RequestBehavior-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestBehavior-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-srv:<RequestBehavior-request> is deprecated: use droneMsgsROS-srv:RequestBehavior-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestBehavior-request>)))
  ...
  "droneMsgsROS/RequestBehaviorRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestBehavior-request)))
  "Returns string type for a service object of type 'RequestBehavior-request"
  "droneMsgsROS/RequestBehaviorRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RequestBehavior-request>)))
  ...
  (cl:format cl:nil "# This service starts a behavior~%~%BehaviorCommand behavior            # The name of the behavior to activate and its argument~%~%================================================================================~%MSG: droneMsgsROS/BehaviorCommand~%# A behavior command is a request to execute a behavior with a set of arguments~%~%string name       # behavior name~%string arguments  # arguments of the behavior~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RequestBehavior-request)))
  "Returns full string definition for message of type 'RequestBehavior-request"
  (cl:format cl:nil "# This service starts a behavior~%~%BehaviorCommand behavior            # The name of the behavior to activate and its argument~%~%================================================================================~%MSG: droneMsgsROS/BehaviorCommand~%# A behavior command is a request to execute a behavior with a set of arguments~%~%string name       # behavior name~%string arguments  # arguments of the behavior~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <RequestBehavior-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RequestBehavior-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-srv:<RequestBehavior-response> is deprecated: use droneMsgsROS-srv:RequestBehavior-response instead.")))
...
(cl:defmethod failed_belief-val ((m <RequestBehavior-response>))
...
(cl:defmethod belief_conflict-val ((m <RequestBehavior-response>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RequestBehavior-response>)))
  ...
  "droneMsgsROS/RequestBehaviorResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RequestBehavior-response)))
  "Returns string type for a service object of type 'RequestBehavior-response"
  "droneMsgsROS/RequestBehaviorResponse")
