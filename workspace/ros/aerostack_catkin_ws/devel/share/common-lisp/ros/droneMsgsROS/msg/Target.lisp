...
(cl:defclass <Target> (roslisp-msg-protocol:ros-message)
  ((bb
    :reader bb
    :initarg :bb
    :type droneMsgsROS-msg:BoundingBox
    :initform (cl:make-instance 'droneMsgsROS-msg:BoundingBox))
   (img
    :reader img
    :initarg :img
...
(cl:defmethod cl:initialize-instance :after ((m <Target>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Target)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-msg:<Target> is deprecated: use droneMsgsROS-msg:Target instead.")))

(cl:ensure-generic-function 'bb-val :lambda-list '(m))
(cl:defmethod bb-val ((m <Target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader droneMsgsROS-msg:bb-val is deprecated.  Use droneMsgsROS-msg:bb instead.")
  (bb m))

(cl:ensure-generic-function 'img-val :lambda-list '(m))
(cl:defmethod img-val ((m <Target>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader droneMsgsROS-msg:img-val is deprecated.  Use droneMsgsROS-msg:img instead.")
  (img m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Target>)))
  ...
  "af750259f2bd9aed12064a11baa3c3c2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Target)))
  "Returns md5sum for a message object of type 'Target"
  "af750259f2bd9aed12064a11baa3c3c2")
