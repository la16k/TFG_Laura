...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-msg:<BoundingBox> is deprecated: use droneMsgsROS-msg:BoundingBox instead.")))
...
(cl:defmethod confidence-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader droneMsgsROS-msg:confidence-val is deprecated.  Use droneMsgsROS-msg:confidence instead.")
  (confidence m))
