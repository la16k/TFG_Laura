...
(cl:defmethod cl:initialize-instance :after ((m <vector3f>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'vector3f)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-msg:<vector3f> is deprecated: use droneMsgsROS-msg:vector3f instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<vector3f>)))
  ...
  (cl:format cl:nil "#This message has the information of a 3D point (float)~%~%~%float32 x~%float32 y~%float32 z~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'vector3f)))
  "Returns full string definition for message of type 'vector3f"
  (cl:format cl:nil "#This message has the information of a 3D point (float)~%~%~%float32 x~%float32 y~%float32 z~%~%~%~%"))
