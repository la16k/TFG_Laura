...
(cl:defmethod cl:initialize-instance :after ((m <ErrorType>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ErrorType)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-msg:<ErrorType> is deprecated: use droneMsgsROS-msg:ErrorType instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ErrorType>)))
  ...
  (cl:format cl:nil "#Error type enum~%~%uint8 UnexpectedProcessStop=0~%uint8 FrozenNode=1~%uint8 InvalidInputData=2~%uint8 SafeguardRecoverableError=3~%uint8 SafeguarFatalError=4~%~%uint8 value~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ErrorType)))
  "Returns full string definition for message of type 'ErrorType"
  (cl:format cl:nil "#Error type enum~%~%uint8 UnexpectedProcessStop=0~%uint8 FrozenNode=1~%uint8 InvalidInputData=2~%uint8 SafeguardRecoverableError=3~%uint8 SafeguarFatalError=4~%~%uint8 value~%~%"))
