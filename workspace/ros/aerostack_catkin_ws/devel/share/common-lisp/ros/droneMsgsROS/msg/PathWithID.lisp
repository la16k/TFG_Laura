...
(cl:defmethod cl:initialize-instance :after ((m <PathWithID>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PathWithID)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name droneMsgsROS-msg:<PathWithID> is deprecated: use droneMsgsROS-msg:PathWithID instead.")))
...
(cl:defmethod poses-val ((m <PathWithID>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader droneMsgsROS-msg:poses-val is deprecated.  Use droneMsgsROS-msg:poses instead.")
  (poses m))
