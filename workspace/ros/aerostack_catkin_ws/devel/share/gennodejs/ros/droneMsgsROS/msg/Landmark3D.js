...
class Landmark3D {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.is_known, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.is_known = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Landmark3D(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
