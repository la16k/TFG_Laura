...
class RequestResourcesRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RequestResourcesRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RequestResourcesRequest
    let len;
    let data = new RequestResourcesRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RequestResourcesRequest(null);
...
class RequestResourcesResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RequestResourcesResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RequestResourcesResponse
    let len;
    let data = new RequestResourcesResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RequestResourcesResponse(null);
