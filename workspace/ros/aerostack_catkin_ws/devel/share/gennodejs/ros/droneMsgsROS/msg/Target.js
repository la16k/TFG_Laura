...
class Target {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BoundingBox.serialize(obj.bb, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.bb = BoundingBox.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += BoundingBox.getMessageSize(object.bb);
  ...
  static Resolve(msg) {
    ...
    if (msg.bb !== undefined) {
      resolved.bb = BoundingBox.Resolve(msg.bb)
    }
    else {
      resolved.bb = new BoundingBox()
    }
