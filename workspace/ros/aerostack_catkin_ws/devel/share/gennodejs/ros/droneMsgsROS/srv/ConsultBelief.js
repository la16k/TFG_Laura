...
class ConsultBeliefRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ConsultBeliefRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ConsultBeliefRequest
    let len;
    let data = new ConsultBeliefRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConsultBeliefRequest(null);
...
class ConsultBeliefResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ConsultBeliefResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ConsultBeliefResponse
    let len;
    let data = new ConsultBeliefResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ConsultBeliefResponse(null);
...
module.exports = {
  Request: ConsultBeliefRequest,
  Response: ConsultBeliefResponse,
  md5sum() { return '17585aa3080fb93549f79950c1309ef2'; },
  datatype() { return 'droneMsgsROS/ConsultBelief'; }
};
