...
class RemoveBeliefRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RemoveBeliefRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RemoveBeliefRequest
    let len;
    let data = new RemoveBeliefRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RemoveBeliefRequest(null);
...
class RemoveBeliefResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RemoveBeliefResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RemoveBeliefResponse
    let len;
    let data = new RemoveBeliefResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RemoveBeliefResponse(null);
...
module.exports = {
  Request: RemoveBeliefRequest,
  Response: RemoveBeliefResponse,
  md5sum() { return '0950bd055fb30d3ee142f3c8cb406a73'; },
  datatype() { return 'droneMsgsROS/RemoveBelief'; }
};
