...
// (in-package mav_msgs_rotors.msg)
...
class TorqueThrust {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TorqueThrust(null);
  ...
  static datatype() {
    ...
    return 'mav_msgs_rotors/TorqueThrust';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TorqueThrust(null);
