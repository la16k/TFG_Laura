...
class QuadrotorPidControllerMode {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new QuadrotorPidControllerMode(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new QuadrotorPidControllerMode(null);
...
QuadrotorPidControllerMode.Constants = {
  POSE: 1,
  SPEED: 2,
  GROUND_SPEED: 3,
  SPEED_3D: 4,
...
module.exports = QuadrotorPidControllerMode;
