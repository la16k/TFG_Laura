...
class FlightMotionControlMode {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FlightMotionControlMode(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new FlightMotionControlMode(null);
...
FlightMotionControlMode.Constants = {
...
module.exports = FlightMotionControlMode;
