...
class PlannerServiceResponse(genpy.Message):
  _md5sum = "2b0f390ba4c264f0182acc6839f4d8b4"
...
Vector3  angular
"""
  __slots__ = ['success','polynomial_plan','sampled_plan']
  _slot_types = ['bool','planning_msgs/PolynomialTrajectory4D','trajectory_msgs/MultiDOFJointTrajectory']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       success,polynomial_plan,sampled_plan
    ...
    if args or kwds:
      ...
      if self.polynomial_plan is None:
        self.polynomial_plan = planning_msgs.msg.PolynomialTrajectory4D()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = planning_msgs.msg.PolynomialSegment4D()
        _v11 = val1.header
        start = end
        end += 4
...
class PlannerService(object):
  ...
  _md5sum = '2300e9625a407fe336df3e99be5434be'
