...
"""autogenerated by genpy from aruco_eye_msgs/MarkerList.msg. Do not edit."""
import sys
...
class MarkerList(genpy.Message):
  _md5sum = "ea0c8ae0355f196f4bfaa5639b0292f9"
  _type = "aruco_eye_msgs/MarkerList"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','aruco_eye_msgs/Marker[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.markers:
        ...
        length = len(val1.pointsInImage)
        buff.write(_struct_I.pack(length))
        for val2 in val1.pointsInImage:
          _x = val2
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.imageTopicName = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        val1 = aruco_eye_msgs.msg.Marker()
        _v7 = val1.header
        start = end
        end += 4
        ...
        val1.pointsInImage = []
        for i in range(0, length):
          val2 = aruco_eye_msgs.msg.PointInImage()
          _x = val2
          start = end
          end += 8
          (_x.x, _x.y,) = _get_struct_2f().unpack(str[start:end])
          val1.pointsInImage.append(val2)
        start = end
        end += 1
