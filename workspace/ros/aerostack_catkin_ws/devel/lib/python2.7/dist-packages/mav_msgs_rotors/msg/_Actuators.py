...
"""autogenerated by genpy from mav_msgs_rotors/Actuators.msg. Do not edit."""
import sys
...
class Actuators(genpy.Message):
  ...
  _type = "mav_msgs_rotors/Actuators"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.angular_velocities))
      length = len(self.normalized)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.normalized))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.angular_velocities = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.normalized = struct.unpack(pattern, str[start:end])
      return self
