...
"""autogenerated by genpy from mav_msgs_rotors/TorqueThrust.msg. Do not edit."""
import sys
...
class TorqueThrust(genpy.Message):
  ...
  _type = "mav_msgs_rotors/TorqueThrust"
...
float64 y
float64 z"""
  __slots__ = ['header','torque','thrust']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6d().pack(_x.torque.x, _x.torque.y, _x.torque.z, _x.thrust.x, _x.thrust.y, _x.thrust.z))
