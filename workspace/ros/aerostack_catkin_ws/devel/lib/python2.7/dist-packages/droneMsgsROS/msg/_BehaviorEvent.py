...
"""autogenerated by genpy from droneMsgsROS/BehaviorEvent.msg. Do not edit."""
import sys
...
class BehaviorEvent(genpy.Message):
  _md5sum = "683ce1141e76d8e30dc854dfe50791bd"
  _type = "droneMsgsROS/BehaviorEvent"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# A behavior event informs about the execution result of a behavior
...
"""
  ...
  __slots__ = ['header','name','uid','failed_belief','belief_conflict','behavior_event_code']
  _slot_types = ['std_msgs/Header','string','float64','string','string','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,uid,failed_belief,belief_conflict,behavior_event_code
    ...
    """
    if args or kwds:
      super(BehaviorEvent, self).__init__(*args, **kwds)
      ...
      if self.behavior_event_code is None:
        self.behavior_event_code = ''
    else:
      self.header = std_msgs.msg.Header()
      self.name = ''
      self.uid = 0.
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.uid,) = _get_struct_d().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.behavior_event_code = str[start:end].decode('utf-8')
      else:
        self.behavior_event_code = str[start:end]
      return self
