...
"""autogenerated by genpy from droneMsgsROS/BoundingBox.msg. Do not edit."""
import sys
...
class BoundingBox(genpy.Message):
  _md5sum = "21805e65f91af60e9268e4d1a43ded1e"
  _type = "droneMsgsROS/BoundingBox"
...
string frame_id
"""
  __slots__ = ['header','x','y','width','height','confidence']
  _slot_types = ['std_msgs/Header','int32','int32','int32','int32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,x,y,width,height,confidence
