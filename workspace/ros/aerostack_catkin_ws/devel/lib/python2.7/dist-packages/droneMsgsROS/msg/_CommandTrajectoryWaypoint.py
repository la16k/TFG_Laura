...
"""autogenerated by genpy from droneMsgsROS/CommandTrajectoryWaypoint.msg. Do not edit."""
import sys
...
class CommandTrajectoryWaypoint(genpy.Message):
  _md5sum = "f77dc076161e6ca1cb6773ac30fbf38a"
  _type = "droneMsgsROS/CommandTrajectoryWaypoint"
...
float32    deltaT
"""
  __slots__ = ['position','velocity','acceleration','deltaT']
  _slot_types = ['float32[3]','float32[3]','float32[3]','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       position,velocity,acceleration,deltaT
    ...
    """
    if args or kwds:
      super(CommandTrajectoryWaypoint, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.deltaT,) = _get_struct_f().unpack(str[start:end])
      return self
