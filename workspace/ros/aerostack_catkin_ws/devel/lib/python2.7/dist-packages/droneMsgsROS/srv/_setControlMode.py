...
"""autogenerated by genpy from droneMsgsROS/setControlModeRequest.msg. Do not edit."""
import sys
...
class setControlModeRequest(genpy.Message):
  ...
  _type = "droneMsgsROS/setControlModeRequest"
...
"""
  ...
  _slot_types = ['droneMsgsROS/droneTrajectoryControllerControlMode']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.controlMode is None:
        self.controlMode = droneMsgsROS.msg.droneTrajectoryControllerControlMode()
    else:
      self.controlMode = droneMsgsROS.msg.droneTrajectoryControllerControlMode()
...
def _get_struct_i():
    ...
    return _struct_i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from droneMsgsROS/setControlModeResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class setControlModeResponse(genpy.Message):
  ...
  _type = "droneMsgsROS/setControlModeResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """
bool ack
...
class setControlMode(object):
  _type          = 'droneMsgsROS/setControlMode'
