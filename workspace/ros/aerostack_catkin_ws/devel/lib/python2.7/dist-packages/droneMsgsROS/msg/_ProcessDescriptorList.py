...
"""autogenerated by genpy from droneMsgsROS/ProcessDescriptorList.msg. Do not edit."""
import sys
...
class ProcessDescriptorList(genpy.Message):
  ...
  _type = "droneMsgsROS/ProcessDescriptorList"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """ProcessDescriptor[] process_list
================================================================================
...
uint8 NotStarted=8"""
  ...
  _slot_types = ['droneMsgsROS/ProcessDescriptor[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = droneMsgsROS.msg.ProcessDescriptor()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
