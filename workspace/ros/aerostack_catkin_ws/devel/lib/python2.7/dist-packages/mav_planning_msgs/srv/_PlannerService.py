...
"""
  ...
  _slot_types = ['bool','mav_planning_msgs/PolynomialTrajectory4D','trajectory_msgs/MultiDOFJointTrajectory']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.polynomial_plan is None:
        self.polynomial_plan = mav_planning_msgs.msg.PolynomialTrajectory4D()
