...
"""autogenerated by genpy from aerostack_msgs/ProcessDescriptor.msg. Do not edit."""
import sys
...
class ProcessDescriptor(genpy.Message):
  ...
  _type = "aerostack_msgs/ProcessDescriptor"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Detailed information about the current state of a process
...
"""
  ...
  _slot_types = ['string','string','time','bool','aerostack_msgs/ProcessState']
