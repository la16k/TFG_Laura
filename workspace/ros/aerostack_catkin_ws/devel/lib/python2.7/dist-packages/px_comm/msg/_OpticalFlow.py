...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_f2h2fB().pack(_x.ground_distance, _x.flow_x, _x.flow_y, _x.velocity_x, _x.velocity_y, _x.quality))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ground_distance, _x.flow_x, _x.flow_y, _x.velocity_x, _x.velocity_y, _x.quality,) = _get_struct_f2h2fB().unpack(str[start:end])
      return self
...
def _get_struct_3I():
    ...
    return _struct_3I
_struct_f2h2fB = None
def _get_struct_f2h2fB():
    global _struct_f2h2fB
    if _struct_f2h2fB is None:
        _struct_f2h2fB = struct.Struct("<f2h2fB")
    return _struct_f2h2fB
