// Generated by gencpp from file aerostack_msgs/BehaviorEvent.msg
// DO NOT EDIT!


#ifndef AEROSTACK_MSGS_MESSAGE_BEHAVIOREVENT_H
#define AEROSTACK_MSGS_MESSAGE_BEHAVIOREVENT_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> const> ConstPtr;

}; // struct BehaviorEvent_

typedef ::aerostack_msgs::BehaviorEvent_<std::allocator<void> > BehaviorEvent;

typedef boost::shared_ptr< ::aerostack_msgs::BehaviorEvent > BehaviorEventPtr;
typedef boost::shared_ptr< ::aerostack_msgs::BehaviorEvent const> BehaviorEventConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::aerostack_msgs::BehaviorEvent_<ContainerAllocator1> & lhs, const ::aerostack_msgs::BehaviorEvent_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >
{
  ...
  static const char* value(const ::aerostack_msgs::BehaviorEvent_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x683ce1141e76d8e3ULL;
  static const uint64_t static_value2 = 0x0dc854dfe50791bdULL;
};

template<class ContainerAllocator>
struct DataType< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::aerostack_msgs::BehaviorEvent_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::aerostack_msgs::BehaviorEvent_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // AEROSTACK_MSGS_MESSAGE_BEHAVIOREVENT_H
