// Generated by gencpp from file mav_msgs_rotors/Status.msg
// DO NOT EDIT!


#ifndef MAV_MSGS_ROTORS_MESSAGE_STATUS_H
#define MAV_MSGS_ROTORS_MESSAGE_STATUS_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::mav_msgs_rotors::Status_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mav_msgs_rotors::Status_<ContainerAllocator> const> ConstPtr;

}; // struct Status_

typedef ::mav_msgs_rotors::Status_<std::allocator<void> > Status;

typedef boost::shared_ptr< ::mav_msgs_rotors::Status > StatusPtr;
typedef boost::shared_ptr< ::mav_msgs_rotors::Status const> StatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::mav_msgs_rotors::Status_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::mav_msgs_rotors::Status_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::mav_msgs_rotors::Status_<ContainerAllocator1> & lhs, const ::mav_msgs_rotors::Status_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::mav_msgs_rotors::Status_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mav_msgs_rotors::Status_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mav_msgs_rotors::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mav_msgs_rotors::Status_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mav_msgs_rotors::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mav_msgs_rotors::Status_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::mav_msgs_rotors::Status_<ContainerAllocator> >
{
  ...
  static const char* value(const ::mav_msgs_rotors::Status_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe191265664a5f7c1ULL;
  static const uint64_t static_value2 = 0x871338dc13be0958ULL;
};

template<class ContainerAllocator>
struct DataType< ::mav_msgs_rotors::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::mav_msgs_rotors::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mav_msgs_rotors::Status_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::mav_msgs_rotors::Status_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::mav_msgs_rotors::Status_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // MAV_MSGS_ROTORS_MESSAGE_STATUS_H
