...
class WindSpeed : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gz_mav_msgs_rotors.WindSpeed) */ {
 public:
  WindSpeed();
  virtual ~WindSpeed();
  ...
  // @@protoc_insertion_point(class_scope:gz_mav_msgs_rotors.WindSpeed)
 private:
