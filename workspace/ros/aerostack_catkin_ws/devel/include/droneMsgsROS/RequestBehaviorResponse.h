// Generated by gencpp from file droneMsgsROS/RequestBehaviorResponse.msg
// DO NOT EDIT!


#ifndef DRONEMSGSROS_MESSAGE_REQUESTBEHAVIORRESPONSE_H
#define DRONEMSGSROS_MESSAGE_REQUESTBEHAVIORRESPONSE_H
...
// reducing the odds to have name collisions with Windows.h 
  ...
  typedef boost::shared_ptr< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> const> ConstPtr;

}; // struct RequestBehaviorResponse_

typedef ::droneMsgsROS::RequestBehaviorResponse_<std::allocator<void> > RequestBehaviorResponse;

typedef boost::shared_ptr< ::droneMsgsROS::RequestBehaviorResponse > RequestBehaviorResponsePtr;
typedef boost::shared_ptr< ::droneMsgsROS::RequestBehaviorResponse const> RequestBehaviorResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator1> & lhs, const ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xcf8aa8441db2d1abULL;
  static const uint64_t static_value2 = 0xaa40db22b8af5ddcULL;
};

template<class ContainerAllocator>
struct DataType< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::droneMsgsROS::RequestBehaviorResponse_<ContainerAllocator>& v)
  {
    s << indent << "uid: ";
...
#endif // DRONEMSGSROS_MESSAGE_REQUESTBEHAVIORRESPONSE_H
