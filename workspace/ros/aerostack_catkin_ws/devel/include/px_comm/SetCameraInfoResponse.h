// Generated by gencpp from file px_comm/SetCameraInfoResponse.msg
// DO NOT EDIT!
...
bool operator==(const ::px_comm::SetCameraInfoResponse_<ContainerAllocator1> & lhs, const ::px_comm::SetCameraInfoResponse_<ContainerAllocator2> & rhs)
{
