...
class CommandMotorSpeed : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:gz_mav_msgs_rotors.CommandMotorSpeed) */ {
 public:
  CommandMotorSpeed();
  ...
  // @@protoc_insertion_point(class_scope:gz_mav_msgs_rotors.CommandMotorSpeed)
 private:
